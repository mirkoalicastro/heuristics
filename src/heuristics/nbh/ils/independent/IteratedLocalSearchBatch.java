...
public class IteratedLocalSearchBatch extends Batch {
     ...
     */
    public IteratedLocalSearchBatch (int numThreads, Function<Vector, Vector> localSearch, Function<Vector, Vector> perturbation, Evaluator decoder, FitnessFunction fitnessFunction, Vector[] feasibleSolutions, Predicate<? super IteratedLocalSearch> stoppingCriterion) {
        if(numThreads < 1)
