...
public class GeneticBatch extends Batch {
     ...
     */
    public GeneticBatch(FitnessFunction fitnessFunction, Configuration config, CrossingOver heredityRule, DNAGenerator individualGenerator, Evaluator decoder, Predicate<Heuristic> stoppingCriterion, long seed) {
        if(config.ip < 1)
